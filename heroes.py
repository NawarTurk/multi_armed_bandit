...
class Heroes: ## The Fellowship class 
    ...
    def attempt_quest(self, hero_index: int):
        ...
        # get the heroe and the hero's success propability
        hero = self.heroes[hero_index]
        success_prob_p = hero['true_success_probability']

        # update quest number
        hero['n_quests'] += 1

        # determine if the quest is success or failuer
        attempt_quest = random.random()
        reward = 0

        if attempt_quest < success_prob_p:
            reward = 1
            hero['successes'] += 1
        #########
...
# print('hi')
# for i in range(1000):
#     heroes.attempt_quest(0)
# print (heroes.heroes[0])

# heroes = Heroes()
# heroes.heroes[0]['true_success_probability'] = 1
# print('hi')
# for i in range(1000):
#     heroes.attempt_quest(0)
# print (heroes.heroes[0])
...
# heroes = Heroes()
# heroes.heroes[0]['true_success_probability'] = 0
# print('hi')
# for i in range(1000):
#     heroes.attempt_quest(0)
# print (heroes.heroes[0])